        ...
        >
            ...
            <div className="flex-grow flex flex-col justify-center items-center mt-10">
                <div className="text-center p-5 bg-black bg-opacity-50 rounded-lg shadow-lg">
                    <h1 className="text-4xl font-bold mb-4">Welcome to MyPookie</h1>
                    <p className="text-lg mb-8">Become a part of MyPookie! Join our community and explore ideas, guides, and stories that empower you to live your best life.</p>
